...
import com.example.managementstore.services.ItemService;
...
public class SearchController {
    ...
    public SearchController(ItemService itemService, CategoryService categoryService, StoreService storeService, ItemRepository itemRepository) {
    ...
    public List<Item> searchByCategory(@PathVariable String category) {
        return itemRepository.findByCategoryNameContaining(category);
    }
